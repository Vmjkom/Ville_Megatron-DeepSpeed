#!/bin/bash
#SBATCH --job-name=FinBert_110M_80gpus_bigrun_newtok
...
DATA_PATH=/scratch/project_462000185/ville/data/Finbert_data/combined/converted/new_tokenizer/single_file_non_weighted/finbert_data
