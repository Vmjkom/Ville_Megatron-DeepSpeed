#!/bin/bash
#SBATCH --job-name=BertXL_64gpu_bigrun_eap_nobinds
...
DATA_PATH=/scratch/project_462000119/ville/Finbert_data/combined/converted/old_tokenizer/single_file_non_weighted/finbert_data
